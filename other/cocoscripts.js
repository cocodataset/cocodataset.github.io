...
var external = [
  ...
  {"name":"Sama-COCO", "url":"https://www.sama.com/sama-coco-dataset/", "src":"images/external/sama.png", "description":"Sama-Coco is a relabelling by Sama of all training and validation images of the original 2017 COCO dataset. Annotation efforts were focused on getting tighter and more accurate polygons around the objects and on decomposing large crowds into smaller individual objects."},
  ...
  {"name":"LILA BC", "url":"https://lila.science", "src":"images/external/lila-bc.jpg", "description":"LILA BC hosts labeled images related to wildlife conservation, including ~20M images from motion-triggered wildlife cameras. Annotations for these images are stored in the (<a href='https://github.com/agentmorris/MegaDetector/blob/main/data_management/README.md#coco-camera-traps-format'>COCO Camera Traps</a>) format, a COCO extension that facilitates train/val splitting for camera trap images by identifying unique locations and image bursts."},
